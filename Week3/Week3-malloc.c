...
int main() {  // Start of the main function, where the program execution begins
    ...
    printf("Enter the size of the array: "); // Prompt the user to input the size of the array
